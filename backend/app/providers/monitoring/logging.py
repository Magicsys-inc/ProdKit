# Source: https://github.com/polarsource/polar/blob/main/server/polar/logging.py
...
class Logging(Generic[RendererType]):
    ...
    @classmethod
    def get_processors(cls, *, logfire: bool) -> list[Any]:  # type: ignore
        return [
    ...
    @staticmethod
    def add_custom_context(**kwargs: Any) -> None:  # type: ignore
